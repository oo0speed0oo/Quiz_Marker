...
class QuestionCountMenu:
    def __init__(self, root, data_folder, filename, start_quiz_callback, show_main_menu_callback):
        self.root = root
    ...
    def start_selected_amount(self):
        ...
        self.start_quiz(self.root, self.filename, amount, self.show_main_menu)
